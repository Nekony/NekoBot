...
from maimai_music import total_list, get_cover_len5_id
...
class DrawBest(object):
    ...
    def __init__(self, sdBest:BestList, dxBest:BestList, userName:str):
        ...
        self.pic_dir = 'src/mai/pic/'
        self.cover_dir = 'src/mai/cover/'
    ...
    def _drawBestList(self, img:Image.Image, sdBest:BestList, dxBest:BestList):
        ...
        titleFontName = 'src/adobe_simhei.otf'
        for num in range(0, len(sdBest)):
            ...
            font = ImageFont.truetype('src/adobe_simhei.otf', 12, encoding='utf-8')
            tempDraw.text((8, 44), f'Base: {chartInfo.ds} -> {computeRa(chartInfo.ds, chartInfo.achievement)}', 'white', font)
            font = ImageFont.truetype('src/adobe_simhei.otf', 18, encoding='utf-8')
    ...
    def draw(self):
        ...
        font1 = ImageFont.truetype('src/msyh.ttc', 28, encoding='unic')
        ...
        font2 = ImageFont.truetype('src/adobe_simhei.otf', 14, encoding='utf-8')
